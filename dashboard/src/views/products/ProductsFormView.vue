            ...
            <div class="w-full">
              <FormKit
                  ...
                  :classes="{
                    ...
                    input: 'block w-full mt-1 pl-2 rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'
                    }"
              />
            </div>
            <div class="flex space-x-3">
              <FormKit
                  ...
                  :classes="{
                    ...
                    input: 'flex flex-1 w-full mt-1 pl-2 rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'
                    }"
              />
              <FormKit
