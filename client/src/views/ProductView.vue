        ...
        <div class="mt-4 lg:row-span-3 lg:mt-0">
          ...
          <div class="mt-6">
            ...
            <div class="flex items-center">
              ...
              <a
                :href="reviews.href"
                class="ml-3 text-sm font-medium text-primary-600 hover:text-primary-500"
          ...
          <form class="mt-10">
            ...
            <a
              v-on:click="addProductToWishlist(router.currentRoute.value.params.id.toString())"
              class="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-8 py-3 text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
            >
              Add to wishlist
            </a>
          </form>
