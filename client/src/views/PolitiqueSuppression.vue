  ...
  <LayoutComponent>
    <div class="bg-white px-6 py-10 lg:px-8">
      <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <p><span >Conform&eacute;ment &agrave; la l&eacute;gislation en vigueur, le Client dispose d&apos;un d&eacute;lai de r&eacute;tractation de 14 jours &agrave; compter de la r&eacute;ception des produits pour retourner un produit qui ne convient pas. Les frais de retour sont &agrave; la charge du Client, sauf en cas de produit d&eacute;fectueux.</span></p>
        <ul>
          <li >
            Service client
          </li>
        </ul>
        <p><span >Pour toute question ou r&eacute;clamation, le Client peut nous contacter via&nbsp;</span><a href="mailto:administration@sneakpeak.fr"><u><span style="color:#1155cc;font-size:11pt;">administration@sneakpeak.fr</span></u></a><span >. Nous nous engageons &agrave; r&eacute;pondre dans les meilleurs d&eacute;lais.</span></p>
        <ul>
          <li >
            Modification des conditions g&eacute;n&eacute;rales de vente
          </li>
        </ul>
        <p><span >Le Vendeur se r&eacute;serve le droit de modifier &agrave; tout moment les pr&eacute;sentes conditions g&eacute;n&eacute;rales de vente. Toute modification sera publi&eacute;e sur notre site.</span></p>
        <p><span >Pour toute question concernant nos conditions g&eacute;n&eacute;rales de vente, veuillez nous contacter &agrave;&nbsp;</span><a href="mailto:administration@sneakpeak.fr"><u><span style="color:#1155cc;font-size:11pt;">administration@sneakpeak.fr</span></u></a><span >.</span></p>
      </div>
    </div>
  </LayoutComponent>
</template>
