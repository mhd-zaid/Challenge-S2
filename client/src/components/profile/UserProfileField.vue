  ...
  <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
    ...
    <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
      ...
      <span class="ml-4 flex-shrink-0">
        <button
          type="button"
          class="rounded-md bg-white font-medium text-primary-600 hover:text-primary-600/60 focus:outline-none focus:ring-2 focus:ring-primary-600/60 focus:ring-offset-2"
          @click="toggleEditing"
        >
